...
- Le service backend pour l'ajout et la suppression de membres (US10) a été implémenté, mais le frontend n'est pas encore terminé.
- Les problèmes liés aux tests ont été corrigés et les tests sont maintenant fonctionnels.

## Prochaines Étapes
1. Compléter le développement du frontend pour US9 et US10.
2. Tester et valider les nouvelles fonctionnalités implémentées.
3. Finaliser la documentation et les tests pour assurer la qualité de la version actuelle du projet.
