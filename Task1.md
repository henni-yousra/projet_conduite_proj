...
| T1.2     | Créer le formulaire d'inscription et de connexion.                                                  | US2           | T0.2, T1.1         | Terminé  | DIALLO               |
| T1.3     | Implémenter la redirection vers le tableau de bord après une connexion réussie.                     | US3           | T1.2               | Terminé  | DREZEN               |
...
| T1.6     | Développer les API REST pour l'inscription, la connexion, et la gestion des utilisateurs.           | US1, US2      | T1.5               | Terminé  | DIALLO               |
| T1.7     | Créer les composants Angular pour la page d’accueil, l'inscription, et la connexion.                | US1, US2      | T1.1               | Terminé  | DREZEN               |
| T1.8     | Connecter le frontend aux API backend pour l’inscription et la connexion des utilisateurs.         | US1, US2      | T1.7, T1.6         | Terminé  | DREZEN               |
...
## Prochaines Étapes
1. Compléter l'intégration frontend-backend pour l'inscription et la connexion.
2. Finaliser le développement de la page de tableau de bord utilisateur.
3. Tester et documenter toutes les fonctionnalités du sprint 1 pour garantir la stabilité de la version 1.0.
